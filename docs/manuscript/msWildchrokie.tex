...
5.17\%, (UI: -6.55, 17.51); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:tab_EOS}). {\Ball}, which did not grow more with longer calendar season, grew less with an earlier start of season ($\beta =$
