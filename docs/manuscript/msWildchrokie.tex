...
16.05\%, (UI: 6.37, 26.05)), Grey birch (\textit{Betula populifolia}; $\beta =$
7.23\%, (UI: 2.33, 12.25)), and Yellow birch (\textit{Betula alleghaniensis}; $\beta =$
4.22\%, (UI: 0.45, 8.15)). Grey alder (\textit{Alnus incana}) trended in the same direction ($\beta =$ 
2.18\%, (UI: -1.10, 5.57)); Figure \ref{fig:wcmuplotbspp}a and e; Table\ref{tab:wc_slope_table}).
Unlike its response to warmer thermal season, {\Ainc} grew more with longer calendar seasons ($\beta =$
5.27\%, (UI: 0.14, 10.66)). {\Bpap} also grew more with longer calendar seasons ($\beta =$ 
20.70\%, (UI: 5.39, 37.14)), while the other two \textit{Betula} did not, though they trended in the same way ({\Ball}: $\beta =$
3.39\%, (UI: -2.69, 9.74), and {\Bpop}: $\beta =$
5.87\%, (UI: -1.91, 13.99); Figure \ref{fig:wcmuplotbspp}b and f; Table \ref{tab:wc_slope_table}). 
...
-7.07\%, (UI: -12.73, -1.14); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Bpop} trended in the opposite direction ($\beta =$
5.05\%, (UI: -6.93, 17.84); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Ball}, which did not grow more with longer calendar season, grew less with an earlier start of season ($\beta =$
10.65\%, (UI: 0.48, 21.60); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table})---but more with a later end of season ($\beta =$ 
12.22\%, (UI: 5.00, 19.68)). Alongside {\Ball}, two other species grew more with a later end of season ({\Bpop}: $\beta =$
10.17\%, (UI: 2.65, 18.03), and {\Bpap}: $\beta =$
23.58\%, (UI: 9.28, 39.01); Figure \ref{fig:wcmuplotbspp}d and h; Table \ref{tab:wc_slope_table}), with the latter being the only one of those three that also grew more with longer calendar season. The estimates were unchanged when using the full (SOS: $n =$
239 and EOS: $n =$
...
10.65\%, (UI: 6.19, 15.33)\%,  compared to an increase of XX% from an earlier start of spring (estimated using our model of GDD shown in cite fig, tables, see methods for more details)
Across species, extending the season by seven days in the autumn increased growth by 
10.65\%, (UI: 6.19, 15.33) \% compared to 
7.13\%, (UI: 4.14, 10.24) \% by extending it in the spring ({\Ainc}, 
SOS: 1.70\%, (UI: -0.86, 4.33) \% versus
EOS: 2.99\%, (UI: -1.50, 7.65) \%; {\Ball}, 
SOS: 4.44\%, (UI: 0.47, 8.57) \% versus
EOS: 7.11\%, (UI: 0.74, 13.82) \%; {\Bpap}, 
SOS: 16.08\%, (UI: 6.38, 26.10) \% versus
EOS: 22.53\%, (UI: 8.76, 37.03) \%; {\Bpop}, 
SOS: 6.30\%, (UI: 2.04, 10.66) \% versus
EOS: 9.98\%, (UI: 3.18, 17.03) \%).
...
1.06\%, (UI: -3.19, 5.21) RW; {\Ball}: $\alpha =$
0.21\%, (UI: -3.97, 4.34) RW; {\Bpap}: $\alpha =$
-4.00\%, (UI: -8.89, 0.75) RW; {\Bpop}: $\alpha =$
-0.66\%, (UI: -4.94, 3.63) RW; Figure \ref{fig:wcxyGDD} and \ref{fig:wcxyGSL}; Table \ref{tab:tab_all}). In addition, growth did not vary with provenance (Dartmouth College (NH): $\alpha =$
-0.03, UI:
-0.22, 
