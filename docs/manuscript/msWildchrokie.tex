...
16.05\%, (UI: 6.37, 26.05) \%/GDD), Grey birch (\textit{Betula populifolia}; $\beta =$
7.23\%, (UI: 2.33, 12.25) \%/GDD), and Yellow birch (\textit{Betula alleghaniensis}; $\beta =$
4.22\%, (UI: 0.45, 8.15) \%/GDD), grey alder (\textit{Alnus incana}) trended in the same direction ($\beta =$ 
2.18\%, (UI: -1.10, 5.57) \%/GDD); Figure \ref{fig:wcmuplotbspp}a and e; Table\ref{tab:wc_slope_table}).
Unlike its response to warmer thermal season, {\Ainc} grew more with longer calendar seasons ($\beta =$
5.27\%, (UI: 0.14, 10.66) \%/day). {\Bpap} also grew more with longer calendar seasons ($\beta =$ 
20.70\%, (UI: 5.39, 37.14) \%/day), while the other two \textit{Betula} did not, though they trended in the same way ({\Ball}: $\beta =$
3.39\%, (UI: -2.69, 9.74) \%/day, and {\Bpop}: $\beta =$
5.87\%, (UI: -1.91, 13.99) \%/day; Figure \ref{fig:wcmuplotbspp}b and f; Table \ref{tab:wc_slope_table}). 
...
-7.07\%, (UI: -12.73, -1.14) \%/day; Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Bpop} trended in the opposite direction ($\beta =$
5.05\%, (UI: -6.93, 17.84) \%/day; Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Ball}, which did not grow more with longer calendar season, grew less with an earlier start of season ($\beta =$
10.65\%, (UI: 0.48, 21.60) \%/day; Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table})---but more with a later end of season ($\beta =$ 
12.22\%, (UI: 5.00, 19.68) \%/day). Alongside {\Ball}, two other species grew more with a later end of season ({\Bpop}: $\beta =$
10.17\%, (UI: 2.65, 18.03) \%/day, and {\Bpap}: $\beta =$
23.58\%, (UI: 9.28, 39.01) \%/day; Figure \ref{fig:wcmuplotbspp}d and h; Table \ref{tab:wc_slope_table}), with the latter being the only one of those three that also grew more with longer calendar season. The estimates were unchanged when using the full (SOS: $n =$
239 and EOS: $n =$
...
9.62\%, (UI: 5.55, 13.85)\%,  compared to an increase of XX% from an earlier start of spring (estimated using our model of GDD shown in cite fig, tables, see methods for more details)
Across species, extending the season by seven days in the autumn increased growth by 
9.62\%, (UI: 5.55, 13.85) \% compared to 
6.47\%, (UI: 3.77, 9.23) \% by extending it in the spring ({\Ainc}, 
SOS: 1.91\%, (UI: -0.97, 4.87) \% versus
EOS: 2.80\%, (UI: -1.40, 7.15) \%; {\Ball}, 
SOS: 3.70\%, (UI: 0.39, 7.12) \% versus
EOS: 5.42\%, (UI: 0.57, 10.50) \%; {\Bpap}, 
SOS: 13.95\%, (UI: 5.57, 22.54) \% versus
EOS: 20.95\%, (UI: 8.19, 34.33) \%; {\Bpop}, 
SOS: 6.31\%, (UI: 2.04, 10.68) \% versus
EOS: 9.32\%, (UI: 2.98, 15.88) \%).
