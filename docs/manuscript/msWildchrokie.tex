...
2.20\%, (UI: -1.08, 5.55)); Figure \ref{fig:wcmuplotbspp}a and e; Table\ref{tab:wc_slope_table}).
...
5.74\%, (UI: -1.96, 13.87); Figure \ref{fig:wcmuplotbspp}b and f; Table \ref{tab:wc_slope_table}). 
...
-7.00\%, (UI: -12.51, -1.16); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Bpop} trended in the opposite direction ($\beta =$
5.17\%, (UI: -6.55, 17.51); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table}). {\Ball}, which did not grow more with longer calendar season, grew less with an earlier start of season ($\beta =$
10.63\%, (UI: 0.34, 21.50); Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:wc_slope_table})---but more with a later end of season ($\beta =$ 
...
23.74\%, (UI: 9.37, 39.20); Figure \ref{fig:wcmuplotbspp}d and h; Table \ref{tab:wc_slope_table}), with the latter being the only one of those three that also grew more with longer calendar season. The estimates were unchanged when using the full (SOS: $n =$
239 and EOS: $n =$
...
7.16\%, (UI: 4.10, 10.31) from an earlier start of spring (estimated using our model estimates of GDD shown in Figure \ref{fig:wcmuplotbspp}, Table \ref{tab} see methods for more details). Differences in magnitude between an extension of SOS versus EOS were similar across species Table()
...
-0.45 (UI:
-1.39, 
0.51) RW; Table \ref{tab:tab_all}), and there were no apparent differences in baseline growth between species ({\Ainc}: $\alpha =$
1.01\%, (UI: -3.14, 5.18) RW; {\Ball}: $\alpha =$
0.15\%, (UI: -4.04, 4.24) RW; {\Bpap}: $\alpha =$
-4.04\%, (UI: -9.02, 0.89) RW; {\Bpop}: $\alpha =$
-0.70\%, (UI: -5.04, 3.50) RW; Figure \ref{fig:wcxyGDD} and \ref{fig:wcxyGSL}; Table \ref{tab:tab_all}). In addition, growth did not vary with provenance (Dartmouth College (NH): $\alpha =$
-0.03 (UI:
-0.22, 
...
0.08 (UI:
-0.08, 
0.30) RW; Figure \ref{fig:wcmuplotasite}; Table \ref{tab:wc_asite_table}). The limited variation between provenances ($\sigma = $
0.18 (UI:
0.02, 
...
\begin{tabular}{lrrrrrr}
  \hline
\textbf{Provenance} & \textbf{Longitude} & \textbf{Latitude} & \textbf{\textit{A. incana}} & \textbf{\textit{B. alleghaniensis}} & \textbf{\textit{B. papyrifera}} & \textbf{\textit{B. populifolia}} \\
 & & & $(n = 29)$ & $(n = 20)$ & $(n = 7)$ & $(n = 25)$ \\
\hline
 \hline
...
\textit{A. incana} & 0.02 [-0.01, 0.05] & 0.05 [0.00, 0.10] & -0.07 [-0.13, -0.01] & -0.01 [-0.07, 0.04] \\ 
  \textit{B. alleghaniensis} & 0.04 [0.01, 0.08] & 0.03 [-0.03, 0.09] & 0.10 [0.00, 0.20] & 0.12 [0.05, 0.18] \\ 
  \textit{B. papyrifera} & 0.15 [0.06, 0.23] & 0.18 [0.05, 0.31] & 0.05 [-0.12, 0.21] & 0.21 [0.09, 0.33] \\ 
  \textit{B. populifolia} & 0.07 [0.03, 0.12] & 0.06 [-0.02, 0.13] & 0.05 [-0.07, 0.16] & 0.10 [0.02, 0.17] \\ 
   \hline
\end{tabular}
\end{table}
...
& \multicolumn{3}{c}{GDD} & \multicolumn{3}{c}{GSL} & \multicolumn{3}{c}{SOS} & \multicolumn{3}{c}{EOS} \\
 \hline
Provenance & Mean & 5\% & 95\% & Mean & 5\% & 95\% & Mean & 5\% & 95\% & Mean & 5\% & 95\% \\ 
  \hline
Harvard Forest (MA) & -0.10 & -0.33 & 0.07 & -0.09 & -0.32 & 0.08 & -0.04 & -0.25 & 0.12 & -0.09 & -0.33 & 0.07 \\ 
  White Mountains (NH) & 0.08 & -0.08 & 0.30 & 0.08 & -0.08 & 0.30 & 0.08 & -0.07 & 0.30 & 0.07 & -0.09 & 0.28 \\ 
  Dartmouth College (NH) & -0.03 & -0.22 & 0.15 & -0.04 & -0.24 & 0.15 & -0.06 & -0.27 & 0.09 & -0.04 & -0.23 & 0.14 \\ 
  St-Hippolyte (Qc) & 0.04 & -0.14 & 0.26 & 0.04 & -0.15 & 0.25 & 0.02 & -0.16 & 0.21 & 0.04 & -0.14 & 0.25 \\ 
   \hline
\end{tabular}
\end{table}
...
& \multicolumn{3}{c}{GDD} & \multicolumn{3}{c}{GSL} & \multicolumn{3}{c}{SOS} & \multicolumn{3}{c}{EOS} \\
 ...
 \hline
  \hline
$\alpha$ & -0.57 & -4.61 & 3.57 & 0.17 & -3.84 & 4.16 & 1.08 & -2.52 & 4.77 & -1.40 & -5.52 & 2.70 \\ 
  $\sigma_{\alpha_{treeid}}$ & 0.17 & 0.05 & 0.27 & 0.18 & 0.05 & 0.28 & 0.21 & 0.11 & 0.30 & 0.19 & 0.07 & 0.28 \\ 
  $\sigma_{\alpha_{prov}}$ & 0.18 & 0.02 & 0.48 & 0.18 & 0.02 & 0.48 & 0.16 & 0.01 & 0.47 & 0.18 & 0.02 & 0.49 \\ 
  ...
  $\beta_{species_{B. alleghaniensis}}$ & 0.04 & 0.01 & 0.08 & 0.03 & -0.03 & 0.09 & 0.10 & 0.00 & 0.20 & 0.12 & 0.05 & 0.18 \\ 
  $\beta_{species_{B. papyrifera}}$ & 0.15 & 0.06 & 0.23 & 0.18 & 0.05 & 0.31 & 0.05 & -0.12 & 0.21 & 0.21 & 0.09 & 0.33 \\ 
  $\beta_{species_{B. populifolia}}$ & 0.07 & 0.03 & 0.12 & 0.06 & -0.02 & 0.13 & 0.05 & -0.07 & 0.16 & 0.10 & 0.02 & 0.17 \\ 
  $\alpha_{prov_{Dartmouth College (NH)}}$ & -0.03 & -0.22 & 0.15 & -0.04 & -0.24 & 0.15 & -0.06 & -0.27 & 0.09 & -0.04 & -0.23 & 0.14 \\ 
  $\alpha_{prov_{Harvard Forest (MA)}}$ & -0.10 & -0.33 & 0.07 & -0.09 & -0.32 & 0.08 & -0.04 & -0.25 & 0.12 & -0.09 & -0.33 & 0.07 \\ 
  $\alpha_{prov_{St-Hippolyte (Qc)}}$ & 0.04 & -0.14 & 0.26 & 0.04 & -0.15 & 0.25 & 0.02 & -0.16 & 0.21 & 0.04 & -0.14 & 0.25 \\ 
  $\alpha_{prov_{White Mountains (NH)}}$ & 0.08 & -0.08 & 0.30 & 0.08 & -0.08 & 0.30 & 0.08 & -0.07 & 0.30 & 0.07 & -0.09 & 0.28 \\ 
  $\alpha_{year_{2018}}$ & 0.17 & -0.77 & 1.14 & 0.22 & -0.71 & 1.16 & 0.21 & -0.75 & 1.18 & 0.23 & -0.70 & 1.17 \\ 
  $\alpha_{year_{2019}}$ & 0.16 & -0.78 & 1.12 & 0.09 & -0.86 & 1.03 & 0.12 & -0.84 & 1.08 & 0.11 & -0.82 & 1.07 \\ 
  $\alpha_{year_{2020}}$ & -0.45 & -1.39 & 0.51 & -0.35 & -1.29 & 0.58 & -0.37 & -1.34 & 0.59 & -0.48 & -1.41 & 0.47 \\ 
  $\alpha_{species_{A. incana}}$ & 1.01 & -3.14 & 5.18 & 0.09 & -3.97 & 4.17 & 1.55 & -2.16 & 5.10 & 3.18 & -1.27 & 7.54 \\ 
  $\alpha_{species_{B. alleghaniensis}}$ & 0.15 & -4.04 & 4.24 & 0.33 & -3.79 & 4.40 & -1.85 & -5.62 & 1.90 & -1.74 & -6.24 & 2.73 \\ 
  $\alpha_{species_{B. papyrifera}}$ & -4.04 & -9.02 & 0.89 & -2.71 & -7.18 & 1.78 & -0.74 & -5.04 & 3.48 & -5.50 & -11.08 & 0.08 \\ 
  $\alpha_{species_{B. populifolia}}$ & -0.70 & -5.04 & 3.50 & 0.18 & -3.92 & 4.33 & -0.47 & -4.33 & 3.31 & -0.75 & -5.40 & 3.84 \\ 
   \hline
\end{tabular}
\end{table}
