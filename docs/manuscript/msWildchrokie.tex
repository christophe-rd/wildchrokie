...
7.16\%, (UI: 4.10, 10.31) from an earlier start of spring (estimated using our model estimates of GDD shown in Figure \ref{fig:wcmuplotbspp} cite fig, tables, see methods for more details)
