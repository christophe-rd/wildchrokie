...
(23.07$^\circ$C), and 2018 in between %DlAug1: Should this be reported in table S2 for easy comparision?
...
-7.00\% (UI: -12.51, -1.16); more growth with an earlier start of season is represented as a negative slope; Figure \ref{fig:wcmuplotbspp}c and g; Table \ref{tab:tab_GSL}). {\Bpop} trended in the opposite direction ($\beta =$
...
-0.70\% (UI: -5.04, 3.50) RW; Figure \ref{fig:wcxyGDD} and \ref{fig:wcxyGSL}; Table \ref{tab:tab_GDD}). In addition, growth did not vary with provenance (Dartmouth College (NH): $\alpha =$
 (UI:
, 
) RW; Harvard Forest (MA): $\alpha =$
 (UI:
, 
) RW; St-Hippolyte (Qc): $\alpha =$
 (UI:
, 
) RW; White Mountains (NH): $\alpha =$
 (UI:
, 
) RW; Figure \ref{fig:wcmuplotasite}; Table \ref{tab:tab_GDD}). The limited variation between provenances ($\sigma = $
0.18 (UI:
0.02, 
...
\hline
 \hline
  \hline
Dartmouth College (NH, USA) & 8 & 7 & 2 & 9 \\ 
  Harvard Forest (MA, USA) & 7 & 0 & 4 & 7 \\ 
  St-Hippolyte (Qc, Canada) & 8 & 6 & 1 & 0 \\ 
  White Mountains (NH, USA) & 6 & 7 & 0 & 9 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{table}[ht]
\centering
\caption{Provenance and common garden location (Arnold Arboretum) coordinates and 1951--1980 climate normals: mean annual temperature (MAT; \degree C), mean summer precipitation (MSP; mm), and frost-free period (FFP; days). We extracted the climate variables at each provenance from \citep{wang_locally_2016}} 
\label{tab:climate}
\begin{tabular}{lrrrrr}
  \hline
Provenance & Latitude & Longitude & MAT & MSP & FFP \\ 
  \hline
Arnold Arboretum (MA, USA) & 42.3 & -71.1 & 7.4 & 450 & 133 \\ 
  Harvard Forest (MA, USA) & 42.5 & -72.2 & 6.8 & 434 & 128 \\ 
  White Mountains (NH, USA) & 44.1 & -71.0 & 3.2 & 490 & 110 \\ 
  Dartmouth College (NH, USA) & 44.9 & -70.7 & 3.4 & 472 & 121 \\ 
  St-Hippolyte (Qc, Canada) & 46.0 & -74.0 & 9.8 & 420 & 162 \\ 
   \hline
\end{tabular}
\end{table}
...
$\alpha$ & -0.57 & -4.61 & -2.30 & 1.14 & 3.57 \\ 
  ...
  $\alpha_{prov_{Dartmouth College (NH, USA)}}$ & -0.03 & -0.22 & -0.08 & 0.03 & 0.15 \\ 
  $\alpha_{prov_{Harvard Forest (MA, USA)}}$ & -0.10 & -0.33 & -0.17 & -0.01 & 0.07 \\ 
  $\alpha_{prov_{St-Hippolyte (Qc, Canada)}}$ & 0.04 & -0.14 & -0.02 & 0.10 & 0.26 \\ 
  $\alpha_{prov_{White Mountains (NH, USA)}}$ & 0.08 & -0.08 & 0.01 & 0.14 & 0.30 \\ 
...
$\alpha$ & 0.17 & -3.84 & -1.48 & 1.83 & 4.16 \\ 
  ...
  $\alpha_{prov_{Dartmouth College (NH, USA)}}$ & -0.04 & -0.24 & -0.09 & 0.02 & 0.15 \\ 
  $\alpha_{prov_{Harvard Forest (MA, USA)}}$ & -0.09 & -0.32 & -0.15 & -0.01 & 0.08 \\ 
  $\alpha_{prov_{St-Hippolyte (Qc, Canada)}}$ & 0.04 & -0.15 & -0.02 & 0.10 & 0.25 \\ 
  $\alpha_{prov_{White Mountains (NH, USA)}}$ & 0.08 & -0.08 & 0.01 & 0.14 & 0.30 \\ 
...
$\alpha$ & 1.08 & -2.52 & -0.44 & 2.56 & 4.77 \\ 
  ...
  $\alpha_{prov_{Dartmouth College (NH, USA)}}$ & -0.06 & -0.27 & -0.12 & 0.00 & 0.09 \\ 
  $\alpha_{prov_{Harvard Forest (MA, USA)}}$ & -0.04 & -0.25 & -0.10 & 0.01 & 0.12 \\ 
  $\alpha_{prov_{St-Hippolyte (Qc, Canada)}}$ & 0.02 & -0.16 & -0.03 & 0.08 & 0.21 \\ 
  $\alpha_{prov_{White Mountains (NH, USA)}}$ & 0.08 & -0.07 & 0.01 & 0.14 & 0.30 \\ 
...
$\alpha$ & -1.40 & -5.52 & -3.10 & 0.32 & 2.70 \\ 
  ...
  $\alpha_{prov_{Dartmouth College (NH, USA)}}$ & -0.04 & -0.23 & -0.09 & 0.02 & 0.14 \\ 
  $\alpha_{prov_{Harvard Forest (MA, USA)}}$ & -0.09 & -0.33 & -0.15 & -0.01 & 0.07 \\ 
  $\alpha_{prov_{St-Hippolyte (Qc, Canada)}}$ & 0.04 & -0.14 & -0.02 & 0.10 & 0.25 \\ 
  $\alpha_{prov_{White Mountains (NH, USA)}}$ & 0.07 & -0.09 & 0.01 & 0.14 & 0.28 \\ 
...
$\alpha$ & 0.62 & -4.52 & -1.50 & 2.77 & 5.84 \\ 
  ...
  $\alpha_{site_{Dartmouth College (NH, USA)}}$ & -0.11 & -0.47 & -0.20 & 0.00 & 0.17 \\ 
