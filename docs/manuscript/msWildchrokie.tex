...
% (\wcjja$tmeanmean[wcjja$year == 2019]$^\circ$C), 2020 the hottest 
% (\wcjja$tmeanmean[wcjja$year == 2020]$^\circ$C), and 2018 in between 
% (\wcjja$tmeanmean[wcjja$year == 2018]$^\circ$C). There was no drought for those three years, except in 2020, when a moderate summer drought (June-August) ramped up to a severe drought in September \citep{nationalcentersforenvironmentalinformationncei_north_2026}
