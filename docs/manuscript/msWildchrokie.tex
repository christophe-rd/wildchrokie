...
Here we used % vvdm25aug: I added 'used' here, I guess it's the verb that was missing?
...
-0.70\% (UI: -5.04, 3.50) RW; Figure \ref{fig:wcxyGDD} and \ref{fig:wcxyGSL}; Table \ref{tab:tab_GDD}). In addition, growth did not vary with provenance (Second College Grant (NH): $\alpha =$
-0.03 (UI:
-0.22, 
...
0.08 (UI:
-0.08, 
0.30) RW; Figure \ref{fig:wcmuplotasite}b; Table \ref{tab:tab_GDD}). The limited variation between provenances ($\sigma = $
0.18 (UI:
0.02, 
...
Harvard Forest (MA, USA) & 7 & 4 & 7 & 0 \\ 
  \shortstack[l]{Second College Grant of\\\hspace*{1em}Dartmouth College (NH, USA)} & 0 & 0 & 0 & 0 \\ 
...
Arnold Arboretum (MA, USA) & 42.3 & -71.1 & 35 & 9.8 & 420 & 162 \\ 
  ...
  Second College Grant of Dartmouth College (NH, USA) & 44.8 & -71.2 & 395 & 4.1 & 420 & 116 \\ 
...
$\alpha$ & -0.57 & -4.61 & -2.30 & 1.14 & 3.57 \\ 
  ...
  $\alpha_{prov_{Second College Grant (NH, USA)}}$ & -0.03 & -0.22 & -0.08 & 0.03 & 0.15 \\ 
...
$\alpha$ & 0.17 & -3.84 & -1.48 & 1.83 & 4.16 \\ 
  ...
  $\alpha_{prov_{Second College Grant (NH, USA)}}$ & -0.04 & -0.24 & -0.09 & 0.02 & 0.15 \\ 
...
$\alpha$ & 1.08 & -2.52 & -0.44 & 2.56 & 4.77 \\ 
  ...
  $\alpha_{prov_{Second College Grant (NH, USA)}}$ & -0.06 & -0.27 & -0.12 & 0.00 & 0.09 \\ 
...
$\alpha$ & -1.40 & -5.52 & -3.10 & 0.32 & 2.70 \\ 
  ...
  $\alpha_{prov_{Second College Grant (NH, USA)}}$ & -0.04 & -0.23 & -0.09 & 0.02 & 0.14 \\ 
