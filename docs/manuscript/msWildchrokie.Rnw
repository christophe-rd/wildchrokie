...
\clearpage
\section{Discussion} 
We found that longer growing seasons increased growth for all four species, but varied depending on the metric used to measure season length, with the thermal growing season more often relating to growth than the calendar season. Thus, our results support the hypothesis that the thermal season is a better predictor for growth \citep{chuine_processbased_2017,wang_simulation_1998}, and suggest that the short and cool spring days early in the season may be less useful for growth than additional days later, when conditions are warmer \citep{buonaiuto_early_2026}. Further supporting this, when we disentangled the calendar season by using the start and end of season separately, we found a larger response of growth to the end of season, with little effect of the start of season.
