...
% vvdm1sept: I tried to improve the opening sentence, as I think a verb was missing somehow... But please check tha I did not modify the meaning... also, I agree that the transition is not perfect
While the long-standing assumption is that tree growth should increase with growing season length, new studies suggest that longer growing seasons may not always increase growth \citep{dow_warm_2022,silvestro_longer_2023,matula_shifts_2023,charletdesauvage_temperature_2022,cabon_crossbiome_2022}. Recently, \cite{dow_warm_2022} found that warmer springs lengthened the growing season, but did not increase the peak growth rate or total annual growth in two temperate forest communities. Working across biomes, \cite{cabon_crossbiome_2022} found a similar trend, where gross primary production and growth appeared decoupled. % vvdm1sept: I splitted the followign sentence in 2 sentences, to improve clarity
However, neither of these studies could clearly establish why they found no relationship . % [in contrast to previous studies] vvdm1sept: I'm not sure this is needed. Also, I wanted to find something else than 'clearly', like 'experimentally'... but it might not be a good choice since your work is not experimental either
...
% Paragraph 5
% vvdm1sept: I tried to improve the transition?
...
\Sexpr{sprintf("%.2f", sigma_df2$p95[sigma_df2$sigma == "sigma_atreeid"])}) RW; Table \ref{tab:tab_GDD}; Figure \ref{fig:fig:wcmuplotatreeid}).
...
By accounting for differences in daily temperatures, the thermal season may align more closely to when and how fast plants can grow each day compared to the calendar season, which assumes a stable influence of each day on growth \citep{korner_four_2023}. Our results suggest significant growth occurs towards the end of the season, but would require data with a finer temporal scale (e.g., daily or weekly data through dendrometers and/or xylogenesis) to confirm this. To date, these studies showed strong species differences in when most growth happens during the season, though most studies are on mature trees \citep[e.g.][]{zweifel_are_2016,etzold_number_2022,balducci_stem_2019}. % However, most of these studies were done on a small number of European and/or conifer species \citep[e.g.][]{zweifel_are_2016,etzold_number_2022,balducci_stem_2019}, highlighting that we need more data across species spanning a wider range of life history strategies.
 ...
 % vvdm1sept: I changed the first sentence slightly, and try to reformulate a sentence after
Our focus on juvenile trees may partly explain why we found increased growth with longer seasons \citep{augspurger_differences_2003,sweeneyComparisonTimingSpring2024}. Younger trees are generally more flexible % vvdm1sept: is 'flexible' really the term? or more something like 'plastic' or such?
than their adult forms \citep{augspurger_differences_2003,way_photoperiod_2015}, allowing them to take advantage of light early in the season or in response to forest gaps. If our juvenile trees grew in a mature forest, they would have been positioned below the canopy and exposed to stronger competition for light and other resources. % Under these more constrained conditions 
Their growth response to longer seasons could therefore have been weaker than what we observed. % in our competition-limited conditions 
...
% should potentially be moved to supplement?
