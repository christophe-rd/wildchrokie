...
% Conceptual figure
\begin{figure}[!ht]
\includegraphics[width=0.9\textwidth]{gsconceptualfig_AdobeI.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=1\textwidth]{asiteMap_AI.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{muALLbsppWlines.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{muProvPerSpp.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.9\textwidth]{climateComparison2020.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{muALLbsppZ.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=1\textwidth]{FullVSRestricted.pdf} 
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{meanPlotGrowthGDD_treeidBYspp.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{growthModelSlopesperSppFacet.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.8\textwidth]{growthModelSlopesperSppFacetGSL.pdf}
