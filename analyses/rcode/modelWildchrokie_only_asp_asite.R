...
# <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
fit <- stan("stan/twolevelhierint_only_asp_asite.stan", 
...
jpeg("figures/aspParameterization_only_asp_asite.jpg", width = 2000, height = 2000, 
     units = "px", res = 300)
util$plot_div_pairs(asp, "sigma_asp", samples, diagnostics, transforms = list("sigma_asp" = 1))
dev.off()

# jpeg("figures/zaspParameterization_only_asp_asite.jpg", width = 2000, height = 2000, 
#      units = "px", res = 300)
...
jpeg("figures/asiteParameterization_only_asp_asite.jpg", width = 2000, height = 2000, 
     units = "px", res = 300)
