...
spp_labels <- unique(bspp_df2_gdd$spp_name)
...
rasterImage(img_thermom,
            usr[1], usr[4] - diff(usr[3:4]) * 0.26,
            usr[1] + diff(usr[1:2]) * 0.20, usr[4] + diff(usr[3:4]) * 0.10)
par(xpd = FALSE)

usr <- par("usr")
axis(2, at = y_pos, labels = FALSE, tick = FALSE)
text(x = bspp_df2_z$p5[1], y = y_pos, col = wccolslatbi,
     labels = spp_labels, 
     pos = 2, xpd = TRUE, cex = 0.75, font = 3)
...
##### GDD posterior recovery #####
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
fitgdd <- readRDS("output/stanOutput/fitGrowthGDD_2xpriors")
...
##### GSL posterior recovery #####
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
fitgsl <- readRDS("output/stanOutput/fitGrowthGSL_2xpriors")
...
##### SOS posterior recovery #####
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
fitsos <- readRDS("output/stanOutput/fitGrowthSOS_2xpriors")
...
##### EOS posterior recovery #####
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
fiteos <- readRDS("output/stanOutput/fitGrowthEOS_2xpriors")
...
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
##### check bspp output with 2x priors ##### 
# --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
pdf("figures/growthModelsMain/2Xpriors/muALLbspp2xP.pdf", width = 7.5, height = 6)
