...
Please consider our paper, entitled `The problem and promise of modeling plant leafout under warmer winters,' as a viewpoint for  \emph{New Phytologist}. % The piece focuses on chilling---the concept of cool temperatures required to break dormancy---working molecular biology forest tree and crop modeling, and research focused on forecasting with climate change. %---to uncover the problems that may limit the potential for rapid progress through new experimental work. % As such we leverage existing data from different fields to show how common some of the unspoken problems with current approaches are.

\emph{What hypotheses or questions does this work address?}

Why do current models of leafout timing with climate change make wildly different predictions for the same system and temperature regime? How can simple models from the 1970s still be equally predictive as newer models, despite apparent progress over the last decades?  We argue progress has stalled because we do not understand how winter temperatures affect leafout. Models today estimate the effect of winter temperatures via an unobserved process called chilling. This has produced fundamental problems that the field has struggled to admit or address.
...
Chilling is a fundamental concept in plant biology with implications for many fruit crops and how well forests can continue to sequester carbon with climate change  \citep{keenan2014net,ipcc2022}. Here we highlight major problems with the concept that result in hidden assumptions and obscured work-arounds in models and experiments, leading to highly uncertain and variable forecasts. We show how new molecular advances \citep[e.g.,][]{zhu2021cold,azeez2021early,pan2023epigenetic,cai2024molecular} may rule out certain common models, and suggest a path towards more mechanistic models and better experiments. 

\emph{Why is this work important and timely?} 
...
In this article we bring a cross-disciplinary and solutions-focused perspective on chilling, bridging across plant physiology, molecular biology, forest tree and crop modelers to highlight the problems that may limit the potential for rapid progress, and show how to fix them. We expect our paper will be controversial, especially from researchers who have focused strongly on modeling chilling (e.g., those working on the Dynamic Model) but believe our viewpoint will accelerate progress. We suggest reviewers on the following page.

% I and my co-authors believe this perspective would be of interest to readers \emph{New Phytologist} and look forward to hearing from you. If have additional questions, please let me know. 
\vspace{1ex}\\
Sincerely,\\
...
\vspace{3ex}\\
{\bf Suggested reviewers:}

Josh M Gray: josh\_gray@ncsu.edu\\
Christy Rollinson: crollinson@mortonarb.org\\
Rea L. Antoniou-Kourounioti: ReaLaila.AntoniouKourounioti@glasgow.ac.uk\\
...
In this perspective 
 ...
 I include below a potential abstract and several potential figures. 
